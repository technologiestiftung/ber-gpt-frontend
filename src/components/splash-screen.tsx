...
export const SplashScreen: React.FC = () => {
	...
	return (
		...
		>
			...
			<p className="py-2">
				Der Einsatz von <b>BärGPT</b> in der öffentlichen Verwaltung bietet eine
				Vielzahl von Vorteilen für Mitarbeitende. Es kann Routineanfragen
				...
				Zufriedenheit der Bürger:innen durch schnellere und präzisere Auskünfte.
				Letztlich fördert BärGPT eine moderne, digitale Berliner Verwaltung und
				verbessert die Effizienz sowie Servicequalität.
			</p>
