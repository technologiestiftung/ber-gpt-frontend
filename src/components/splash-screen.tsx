...
export const SplashScreen: React.FC = () => {
	...
	return (
		<div
			ref={splashContainer}
			className={`pointer-events-auto relative z-50 m-1 flex h-fit w-fit rounded border-2 border-mid-grey bg-white shadow-lg sm:mx-auto sm:my-10 sm:h-fit sm:w-[540px]`}
		>
