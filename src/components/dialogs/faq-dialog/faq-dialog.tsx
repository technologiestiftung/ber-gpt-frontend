			...
			<div className="w-full flex justify-center">
				<div className="flex flex-col gap-7 max-w-[600px]">
					...
					<p>
						...
						Beschäftigten der Berliner Verwaltung kontinuierlich erweitert
						werden. Hierzu werden wir in Zukunft regelmäßige Workshop-Formate
						anbieten und freuen uns über Ideen und{" "}
						<a
							className="text-ber-mid-grey underline hover:text-ber-darker-grey"
					...
					<div className="flex flex-row flex-wrap justify-start gap-10 border-t border-ber-light-grey pt-6">
						{logoLinks.map((link) => (
							<a
								key={link.href}
								href={link.href}
